...
public class ListMyLances extends ModelCleanStringHandler{
    public ListMyLances(Context context, RequestQueue refRequestQueue) {
        super(context, ((HubActivity) context).getRequestQueue());
        this.setMethod(Request.Method.GET);
        this.setUrl(Connections.URL_GET_MY_LANCE);
    }
